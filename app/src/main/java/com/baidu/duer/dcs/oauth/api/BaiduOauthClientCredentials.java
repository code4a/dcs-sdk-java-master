...
import com.baidu.duer.dcs.http.callback.StringDcsCallback;
 ...
 * TODO: 百度Oauth2授权方式完善
 */
public class BaiduOauthClientCredentials implements Parcelable {
     ...
     */
    public void authorize(Application activity, OauthRequest.OauthCallback<OauthClientCredentialsInfo> listener) {
