...
public class PayloadConfig {
    ...
    private PayloadConfig() {
        ...
        // SmartGateway
        namespace = com.baidu.duer.dcs.devicemodule.cmccgateway.ApiConstants.NAMESPACE;
        name = com.baidu.duer.dcs.devicemodule.cmccgateway.ApiConstants.Directives.Add.NAME;
        insertPayload(namespace, name, ControlDevicePayload.class);
        name = com.baidu.duer.dcs.devicemodule.cmccgateway.ApiConstants.Directives.Remove.NAME;
        insertPayload(namespace, name, ControlDevicePayload.class);
        name = com.baidu.duer.dcs.devicemodule.cmccgateway.ApiConstants.Directives.Bind.NAME;
        insertPayload(namespace, name, ControlGatewayPayload.class);
        name = com.baidu.duer.dcs.devicemodule.cmccgateway.ApiConstants.Directives.UnBind.NAME;
        insertPayload(namespace, name, ControlGatewayPayload.class);
    }
