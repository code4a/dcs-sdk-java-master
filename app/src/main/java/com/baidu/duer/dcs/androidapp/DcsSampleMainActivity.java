...
//
//                });
        deviceModuleFactory.createSmartGatewayDeviceModule();
        deviceModuleFactory.getSmartGatewayDeviceModule()
    ...
    private void showShortToast(String deviceName) {
        Toast.makeText(DcsSampleMainActivity.this, deviceName, Toast.LENGTH_SHORT).show();
    }
