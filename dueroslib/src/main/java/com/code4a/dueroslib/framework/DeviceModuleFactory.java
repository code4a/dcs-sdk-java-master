...
import com.code4a.dueroslib.devicemodule.alerts.AlertsDeviceModule;
import com.code4a.dueroslib.devicemodule.audioplayer.AudioPlayerDeviceModule;
import com.code4a.dueroslib.devicemodule.cmccgateway.SmartGatewayDeviceModule;
import com.code4a.dueroslib.devicemodule.playbackcontroller.PlaybackControllerDeviceModule;
import com.code4a.dueroslib.devicemodule.screen.ScreenDeviceModule;
import com.code4a.dueroslib.devicemodule.screen.extend.card.ScreenExtendDeviceModule;
import com.code4a.dueroslib.devicemodule.speakcontroller.SpeakerControllerDeviceModule;
import com.code4a.dueroslib.devicemodule.system.SystemDeviceModule;
...
import com.code4a.dueroslib.devicemodule.voiceoutput.VoiceOutputDeviceModule;
...
public class DeviceModuleFactory {
    ...
    private SmartGatewayDeviceModule smartGatewayDeviceModule;
    ...
    public void createSmartGatewayDeviceModule(){
        smartGatewayDeviceModule = new SmartGatewayDeviceModule(deviceModuleHandler.getMessageSender());
        deviceModuleHandler.addDeviceModule(smartGatewayDeviceModule);
    }

    public SmartGatewayDeviceModule getSmartGatewayDeviceModule(){
        return smartGatewayDeviceModule;
    }
